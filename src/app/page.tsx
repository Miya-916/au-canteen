...
export default function Home() {
  ...
  return (
    <div className="relative min-h-screen overflow-hidden bg-zinc-50 dark:bg-black">
      ...
      <Image src= "/background.JPG" alt="" fill sizes="80vw" className="object-cover object-[center_5%] opacity-80" priority />
      ...
      <div className="relative mx-auto flex min-h-screen max-w-lg items-center justify-center px-4 py-10">
        ...
        <div className="flex flex-col items-center text-center">
          ...
          <h1 className="mt-2 text-3xl font-semibold tracking-tight text-zinc-900 dark:text-zinc-100"> {BRAND_NAME} </h1>
          <p className="mt-1 text-sm text-zinc-600 dark:text-zinc-400"> Sign in to continue, or create a customer account. </p>
        </div>

          <div className="mt-7 space-y-4">
            <div>
              <label className="mb-1.5 block text-sm font-medium text-zinc-700 dark:text-zinc-300"> Choose role </label>
              <select
                value={role}
                onChange={(e) => setRole(e.target.value as Role)}
                className="block w-full rounded-xl border border-zinc-300 bg-white px-4 py-3 text-base text-zinc-900 outline-none focus:border-indigo-500 focus:ring-2 focus:ring-indigo-500/20 dark:border-zinc-700 dark:bg-zinc-800 dark:text-zinc-100"
              >
            ...
            <div className="grid grid-cols-1 gap-3 sm:grid-cols-2">
              ...
              <button
                ...
                className="inline-flex h-12 w-full items-center justify-center rounded-xl border border-zinc-300 bg-white px-4 text-sm font-medium text-zinc-900 hover:bg-zinc-50 disabled:cursor-not-allowed disabled:opacity-60 dark:border-zinc-700 dark:bg-zinc-900 dark:text-zinc-100 dark:hover:bg-zinc-800"
              > Sign Up </button>
            </div>
