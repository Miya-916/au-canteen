  ...
  return (
    <div className="min-h-screen bg-zinc-50 dark:bg-black">
      <section id="home" className="relative w-full overflow-hidden pt-[52px] sm:pt-[56px]">
        ...
        <div className="relative mx-auto h-[42svh] min-h-[320px] max-h-[420px] sm:h-[54svh] sm:min-h-[520px] sm:max-h-[640px] max-w-8xl px-0 pt-4 pb-8 sm:py-14">
      ...
      <main id="shops" className="mx-auto max-w-6xl px-4 py-6 sm:px-6 sm:py-8">
        <ShopGallery
          allShops={all}
