...
export default async function CustomerHome() {
  ...
  const bestSelling = bestSellingRaw.map((s) => ({
    ...s,
    reason: `${Number(s.orders_count || 0)} orders`,
  }));

  const timeBased = timeBasedRaw.map((s) => ({
    ...s,
    reason: `${Number(s.orders_count || 0)} orders`,
  }));
  ...
  const recommendedTop =
    (timeBased.length ? timeBased : bestSelling.length ? bestSelling : all).slice(
      0,
      1
    );
  ...
  return (
    <div className="min-h-screen bg-zinc-50 dark:bg-black">
      <section id="home" className="relative w-full overflow-hidden pt-[52px] sm:pt-[56px]">
        <div className="fixed inset-x-0 top-0 z-50 w-full border-b border-white/15 bg-[#8b0000]/85 backdrop-blur">
          <div className="w-full px-3 sm:px-6">
            <div className="flex items-center justify-between gap-3 py-2">
              ...
              <div className="hidden md:flex items-center gap-4 shrink-0 mr-auto">
                <a
                  href="#home"
              ...
              <div className="flex items-center gap-2 sm:gap-4 shrink-0">
                ...
                <Link
                  ...
                  className="rounded-md border border-white/25 bg-white/10 px-3 py-2 text-sm font-medium text-white hover:bg-white/15"
                >
                  <span className="hidden sm:inline"> ❤️ My Favorites </span>
        ...
        <div className="relative mx-auto h-[52vh] min-h-[320px] max-h-[560px] sm:h-[60vh] sm:min-h-[420px] sm:max-h-[760px] max-w-8xl px-0 pt-7 pb-5 sm:pt-12 sm:pb-8">
          <div className="relative z-10 px-4 sm:px-6">
            ...
            <p className="mt-3 max-w-2xl text-sm leading-7 text-white/90 sm:text-base">
              Explore your favorite stalls, discover best sellers, and find what
              to eat faster
            </p>
      ...
      <main id="shops" className="mx-auto max-w-6xl px-4 py-3 sm:py-6">
        <ShopGallery
          allShops={all}
      ...
      >
        <div className="mx-auto max-w-6xl px-4 sm:px-6">
          ...
          <p className="mt-2 max-w-3xl text-sm leading-7 text-zinc-600 dark:text-zinc-400">
            AU Canteen helps students and staff discover food stalls, browse
            menus, and find their favorite meals inside the university canteen.
            The platform is designed to make ordering and exploring food options
            easier and more convenient for everyone on campus.
          </p>
        </div>
      </section>
    </div>
